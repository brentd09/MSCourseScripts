...
$VaultName = "vault-m4kiug26" #fetch automatically
$Subscription = "MSDN Platforms" #fetch automatically
$ResourceGroup = "DemoVnet" #fetch automatically
$SubscriptionId = "26fe2113-5b45-4491-80c6-8f51f54182b5" #fetch automatically
...
if($isVaultSoftDeleteFeatureEnabled -eq $false) {
	Set-AzRecoveryServicesVaultProperty -VaultId $VaultToDelete.ID -SoftDeleteFeatureState Disable #disable soft delete
